...
- 원본 이미지를 불러올 때 메모리 용량을 과하게 차지한다(메모리 사용량: 약 400MB -> 600MB~1GB) : 해결 
- 즐겨찾기 이미지를 추가한 후 메모리가 200MB -> 805MB 까지 올라가는 현상 해결하기 
- 파일 아이콘 최적화 하기 
<br>
...
- 윈도우 파일 탐색기에서 `디렉토리 or 파일을 드래그앤 드롭으로 추가`할 수 있도록 기능 추가 
...
- `크로키 목록`, `탐색기`, `메인화면`, `옵션 창 On/Off 기능` 추가 
- UI 오류 수정 
...
- `이미지 회전`, `흑백 모드`, `좌우 반전 구현` 완료 
- 크로키 목록에서 파일 이미지를 더블클릭할 때 미리보기 이벤트가 실행되는 문제 해결 

-----------------------------------------------------------------------------------------------------------------------------------------------------------

[2023-09-10]

- 이미지 이름을 출력 후, 이미지를 추가하도록 구현 

-----------------------------------------------------------------------------------------------------------------------------------------------------------

[2023-09-08]

- 북마크 기능 구현 완료 (이미지 최적화 필요) 
- 창을 맨 위에 위치할 수 있는 기능 추가 
...
5. 북마크 기능 필요함 > 완료 
6. 좌우 반전,이미지 회전, 흑백 모드 같은 이미지 처리 기능 필요함 > 완료 
7. 이미지만 보이게 탭 키 등으로 경로 창 등 열고 닫는 기능 필요함
8. 이미지 스킵, 넘기기 기능 필요함
9. 창 크기 조절 시도 시 팅기는 현상 있음 개선 필요함 > 완료 
